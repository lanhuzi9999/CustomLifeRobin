...
/**
 * ****************************************************************<br>
 * 文件名称 : SwitchButton.java<br>
 * 作 者 : zj<br>
 * 创建时间 : 2014-12-18 14:32:11<br>
 * 文件描述 : 自定义SwitchButton<br>
...
public class SwitchButton extends CompoundButton
{
    ...
    private void init(AttributeSet attrs)
    {
        ...
        setCheckedWithOutAnimation(isChecked());
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        buttonRectF.set(buttonLeft, buttonTop, buttonLeft
                + (frameDrawable != null ? frameDrawable.getIntrinsicWidth() : 0), buttonTop
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (stateDrawable != null && stateMaskDrawable != null)
        {
            ...
            if (stateMaskDrawable != null && stateBitmap != null && !stateBitmap.isRecycled())
            {
                ...
                int src = canvas.saveLayer(0, 0, getWidth(), getHeight(), paint, Canvas.MATRIX_SAVE_FLAG
        ...
        switch (event.getActionMasked())
        {
            ...
            case MotionEvent.ACTION_UP:
            {
                ...
                {// 这是滑动操作
                    ...
                    if (Math.abs(tempTotalSlideDistance) >= Math.abs(frameDrawable.getIntrinsicWidth()
    ...
    {
        return super.verifyDrawable(who) || who == frameDrawable || who == stateDrawable || who == stateMaskDrawable
                || who == sliderDrawable;
    }
     ...
     */
    public void setDrawables(Drawable frameBitmap, Drawable stateDrawable, Drawable stateMaskDrawable,
            Drawable sliderDrawable)
    {
     ...
     */
    public void setDrawableResIds(int frameDrawableResId, int stateDrawableResId, int stateMaskDrawableResId,
            int sliderDrawableResId)
    {
        if (getResources() != null)
        {
            setDrawables(getResources().getDrawable(frameDrawableResId),
                    getResources().getDrawable(stateDrawableResId), getResources().getDrawable(stateMaskDrawableResId),
