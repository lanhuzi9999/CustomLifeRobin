...
import so.contacts.hub.services.baseservices.ui.YellowPageIndicatorFragmentActivity.TabInfo;
...
/**
 * 文件名称: PagerSlidingTabStrip.java <br>
 * 版权声明 : 深圳市葡萄信息技术有限公司 版权所有 <br>
 * 创建人员: Andreas Stuetz <andreas.stuetz@gmail.com><br>
 * 修改人员: wcy
 * 文件描述: 具备多种配置功能的线性viewpager指示器
 * 修改时间: 2015-10-13 下午2:45:02 <br>
 * 修改历史：  2015-10-13 1.00 初始版本
 */
@SuppressLint("NewApi")
...
//    private int tabTypefaceStyle = Typeface.BOLD;
    ...
    private int tabBackgroundResId = R.drawable.putao_pagerslideindicator_background_tab;
    ...
    public void notifyDataSetChanged()
    {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                ...
                if (getTab(currentPosition) instanceof TextView)
                {
                    ((TextView) getTab(currentPosition)).setTextColor(getResources().getColor(R.color.putao_tab_indicator_text_selected));
                }
    ...
    private class PageListener implements OnPageChangeListener
    {
        ...
        public void onPageSelected(int position)
        {
            ...
            if (getTab(selectedPosition) instanceof TextView)
            {
                ((TextView) getTab(selectedPosition)).setTextColor(getResources().getColor(R.color.putao_tab_indicator_text_unselected));
                ((TextView) getTab(position)).setTextColor(getResources().getColor(R.color.putao_tab_indicator_text_selected));
            }
